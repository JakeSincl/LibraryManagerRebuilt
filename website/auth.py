...
with open("adminHash.txt", "w") as f:
  f.write(generate_password_hash("admin", method="sha256"))
...
def sign_up():
    if request.method == "POST":
        ...
        elif not check_password_hash((open("adminHash.txt", "r")).readlines()[0], userCode):
